...
def monitoring_manager(config_manager_mock):
    ...
    with patch('nexus_core.core.monitoring_manager.Gauge'), \
         patch('nexus_core.core.monitoring_manager.Counter'), \
         patch('nexus_core.core.monitoring_manager.Histogram'), \
         patch('nexus_core.core.monitoring_manager.start_http_server'):
...
def test_monitoring_manager_initialization(mock_psutil, config_manager_mock):
    ...
    with patch('nexus_core.core.monitoring_manager.Gauge'), \
         patch('nexus_core.core.monitoring_manager.Counter'), \
         patch('nexus_core.core.monitoring_manager.Histogram'), \
         patch('nexus_core.core.monitoring_manager.start_http_server') as mock_start_server:
        ...
        config_manager_mock.register_listener.assert_called_with(
            'monitoring', 
            monitoring_mgr._on_config_changed
        )
...
def test_register_metrics(monitoring_manager):
    ...
    with patch('nexus_core.core.monitoring_manager.Gauge') as mock_gauge, \
         patch('nexus_core.core.monitoring_manager.Counter') as mock_counter, \
         patch('nexus_core.core.monitoring_manager.Histogram') as mock_histogram, \
         patch('nexus_core.core.monitoring_manager.Summary') as mock_summary:
        ...
        summary = monitoring_manager.register_summary(
            name="custom_summary",
            description="A custom summary metric"
        )
